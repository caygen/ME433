...
// I2C pins need pull-up resistors, 2k-10
#include <xc.h>
#include "i2c_master_noint.h"

void i2c_master_setup(void) {
  I2C2BRG = 53;                     // I2CBRG = [1/(2*Fsck) - PGD]*Pblck - 2// Fsck=400kHz &Pbclk = 48MHz
  ANSELBbits.ANSB2 = 0;             // turn off default analog pin B2
  ANSELBbits.ANSB3 = 0;             // turn off default analog pin B3                                  // look up PGD for your PIC32
